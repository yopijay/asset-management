...
INSERT INTO "public"."tbl_routes" VALUES (2, 'RTS-0000002', 'TOOLS', 'tools', NULL, 1, 1, NULL, NULL, NULL, '2023-11-10 11:45:17+08', NULL, NULL, NULL);
...
-- ----------------------------
INSERT INTO "public"."tbl_users_info" VALUES (1, 1, '00000000', '0000000000', NULL, NULL, NULL, NULL, 'MIS', NULL, 'ADMIN', NULL, NULL, NULL, NULL);
...
SELECT setval('"public"."tbl_department_id_seq"', 2, true);
...
SELECT setval('"public"."tbl_module_id_seq"', 4, true);
...
SELECT setval('"public"."tbl_modules_id_seq"', 4, true);
...
SELECT setval('"public"."tbl_position_id_seq"', 2, true);
...
SELECT setval('"public"."tbl_routes_id_seq"', 4, true);
...
SELECT setval('"public"."tbl_setup_id_seq"', 3, false);
...
SELECT setval('"public"."tbl_stocks_issuance_id_seq"', 2, false);
...
SELECT setval('"public"."tbl_users_id_seq"', 3, true);
...
SELECT setval('"public"."tbl_users_info_id_seq"', 3, true);
