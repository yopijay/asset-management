    ...
    useEffect(() => { 
        if(data.user_level !== 'superadmin' && 
            (data.permission === null || 
                !(JSON.parse(data.permission).maintenance.department.create || 
                    JSON.parse(data.permission).maintenance.department.update || 
                    JSON.parse(data.permission).maintenance.department.view))) { navigate('/'); }
        else {
