    ...
    useEffect(() => { 
        if(data.user_level !== 'superadmin' && 
            (data.permission === null || 
                !(JSON.parse(data.permission).maintenance.company.create || 
                    JSON.parse(data.permission).maintenance.company.update || 
                    JSON.parse(data.permission).maintenance.company.view))) { navigate('/'); }
        else { 
