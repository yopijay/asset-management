    ...
    useEffect(() => { 
        if(data.user_level !== 'superadmin' && 
            (data.permission === null || 
                !(JSON.parse(data.permission).maintenance.position.create || 
                    JSON.parse(data.permission).maintenance.position.update || 
                    JSON.parse(data.permission).maintenance.position.view))) { navigate('/'); }
        else {
