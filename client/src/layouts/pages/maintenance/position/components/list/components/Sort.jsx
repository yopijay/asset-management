...
const Sort = ({ records }) => {
    ...
    const onclick = name => { setValue('orderby', name); setorder(name); records({ table: 'tbl_position', data: getValues() }); }
    const onsort = sort => { setsort(sort); setValue('sort', sort); records({ table: 'tbl_position', data: getValues() }); }
