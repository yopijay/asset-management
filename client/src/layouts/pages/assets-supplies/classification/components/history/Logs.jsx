...
const Logs = () => {
    const { data: log, isFetching: fetching } = useGet({ key: ['asc_logs'], request: history({ table: 'tbl_assets_supplies_classification', data: {} }), options: { refetchOnWindowFocus: false } }); 
